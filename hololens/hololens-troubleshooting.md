...
这是影响使用 Insider 预览版的用户的问题，使用新的预览体验内部版本重新HoloLens 2预览体验版，然后从预览体验计划取消注册。 这是一个 **已知问题**。
...
- 重新运行设备
    ...
    1. 在[未HoloLens 2](hololens-recovery.md)完全关闭电源，将设备手动置于闪烁模式。 然后，在按住"音量"的同时，点击"电源"按钮。
...
若要确保HoloLens看到手，需要将它们放在手势框架中。  混合现实主页提供反馈，让你了解何时跟踪手部。  对于不同版本的服务，反馈HoloLens：
...
- 英语 QWERTY 蓝牙键盘 (，可以在使用全息键盘键盘) 。
- 蓝牙鼠标。
- 单击[HoloLens单击器](hololens1-clicker.md)。

可以将其他 HID 蓝牙 GATT 设备与设备配对HoloLens。 但是，可能需要从设备安装相应的Microsoft Store应用，以实际使用设备。
