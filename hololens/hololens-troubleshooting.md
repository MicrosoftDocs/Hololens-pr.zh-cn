...
- 更新设备以在同一主要内部版本（例如 Windows Holographic 版本 2004）上进行大型更新，Windows Holographic 版本 20H2
- 将设备从工厂映像更新到最新映像
...
如果视器具有指纹或指纹，请使用设备中随指纹HoloLens清理视器。
...
- 确保 Wi-Fi 已打开。 若要检查，请使用"开始"手势，然后选择 **设置**  >  **网络 &amp; Internet**  >  **Wi-Fi"。** 如果 Wi-Fi 处于打开状态，请尝试将其关闭，然后重新打开。
- 移动以靠近路由器或接入点。
