...
### <a name="is-windows-hello-for-business-supported-on-hololens-1st-gen"></a>是否Windows Hello第一代 HoloLens (支持企业) ？

Windows Hello第一代 (支持使用 PIN 登录) 企业HoloLens (企业) 。 若要Windows Hello企业 PIN 登录，请HoloLens：
