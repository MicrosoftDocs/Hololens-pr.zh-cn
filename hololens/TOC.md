...
### [HoloLens（第一代）舒适佩戴常见问题解答](hololens1-fit-comfort-faq.md)
### [安装 HoloLens（第一代）的本地化版本](hololens1-install-localized.md)
...
## [许可证要求](hololens-licenses-requirements.md)
## 环境
...
## 修复 HoloLens 问题
### [疑难解答](hololens-troubleshooting.md)
### [重启、重置或恢复 HoloLens 2](hololens-recovery.md)
### [重启、重置或恢复 HoloLens（第 1 代） ](hololens1-recovery.md)
### [常见问题](hololens-faq.md)
### [HoloLens 已知问题](hololens-known-issues.md)
### [收集和使用来自 HoloLens 设备的诊断信息](hololens-diagnostic-logs.md)
### [获取支持](https://support.microsoft.com/supportforbusiness/productselection?sapid=e9391227-fa6d-927b-0fff-f96288631b8f)
...
### [Web 应用安装程序](app-deploy-web-installer.md)
