...
#### [使用“开始”菜单和混合现实主页](holographic-home.md)
...
#### [HoloLens 环境注意事项](hololens-environment-considerations.md)
#### [移动平台](hololens2-moving-platform.md)
### 连接 HoloLens 2
...
# 部署 HoloLens 2
## [常见部署方案](hololens-requirements.md)
## [规划 HoloLens 2 部署](hololens-core-components.md)
## 部署指南
### 连接到云的环境部署指南
#### [概述](hololens2-cloud-connected-overview.md)
#### [准备](hololens2-cloud-connected-prepare.md)
...
#### [配置](hololens2-corp-connected-configure.md)
#### [部署](hololens2-corp-connected-deploy.md)
#### [维护](hololens2-corp-connected-maintain.md)
### [脱机安全环境部署指南](hololens-common-scenarios-offline-secure.md)
### [许可要求](hololens-licenses-requirements.md)
## 标识
...
### [状态分离和隔离](security-state-separation-isolation.md)
### [无管理操作系统](security-adminless-os.md)
### [限制密码的使用](security-limiting-password-use.md)
...
# 疑难解答
## [设备](hololens-troubleshooting.md)
## [全息影像和交互](hololens-faq.md)
## [显示器](hololens2-display.md)
## [实现和托管设备](hololens2-enterprise-troubleshooting.md#)
## [启用诊断日志](hololens-diagnostic-logs.md)
## [重启、重置或恢复 HoloLens 2](hololens-recovery.md)
...
## [了解 Microsoft Mesh（预览版）](/mesh/overview)
## HoloLens（第 1 代）
### 首次使用
...
#### [重启、重置或恢复 HoloLens（第 1 代）](hololens1-recovery.md)
### HoloLens（第 1 代）安全性
