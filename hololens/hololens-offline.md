...
|                                                     | msagfx.live.com                                                     |   |   |   |
|                                                     | oneclient.sfx.ms                                                    |   |   |   |
| “照片”应用                                          | evoke-windowsservices-tas.msedge.net                                |   |   |   |
...
> [!NOTE]
> 如果要部署 D365 Remote Assist，必须在此[列表](https://docs.microsoft.com/office365/enterprise/urls-and-ip-address-ranges#skype-for-business-online-and-microsoft-teams)上启用终结点 
...
- [管理从 Windows 10 操作系统组件到 Microsoft 服务的连接](https://docs.microsoft.com/windows/privacy/manage-connections-from-windows-operating-system-components-to-microsoft-services)
- [使用 Microsoft Intune MDM 服务器管理从 Windows 10 操作系统组件到 Microsoft 服务的连接](https://docs.microsoft.com/windows/privacy/manage-connections-from-windows-operating-system-components-to-microsoft-services-using-mdm)
- [Intune 网络配置要求和带宽](https://docs.microsoft.com/intune/fundamentals/network-bandwidth-use#network-communication-requirements)
- [Microsoft Intune 网络终结点](https://docs.microsoft.com/intune/fundamentals/intune-endpoints)
